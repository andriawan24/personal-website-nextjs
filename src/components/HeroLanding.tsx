...
export default function Hero() {
  return (
    <div className="flex flex-row items-center gap-28 py-20 px-32">
      <div>
        <h1 className="text-5xl leading-140 font-bold text-color-text-primary">
          Naufal Fawwaz Andriawan
        </h1>
        <h3 className="text-2xl leading-140 font-semibold text-color-text-primary">
          Software Engineer
        </h3>
        ...
        <div className="flex flex-row items-center mt-8 gap-6">
          ...
          >
            <span className="text-color-text-primary text-lg font-bold leading-140">
              Resume PDF
            </span>
            <IconArrowUpRight />
          </Link>
