...
export default function ProjectForm({ project }: { project: ProjectTypes }) {
  const [state, action] = useFormState(updateProject, undefined);
        ...
        <div className="flex flex-col flex-1">
          <Field name="title" className="flex flex-col">
            <Field name="id" className="hidden">
              <Control defaultValue={project.id} />
            </Field>
        ...
        <div className="flex flex-col flex-1">
          <Field name="development_date" className="flex flex-col">
            ...
            <Control
              ...
              defaultValue={project.development_start_date}
            />
          ...
          <Field name="full_image" className="mt-4 flex flex-col">
            ...
            <Image
              src={
                selectedFullImage
                  ? URL.createObjectURL(selectedFullImage)
                  : project.cover_image
              }
              width={500}
              height={500}
            ...
            <Image
              src={
                selectedThumbnailImage
                  ? URL.createObjectURL(selectedThumbnailImage)
