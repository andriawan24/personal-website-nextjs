...
function DesktopNav() {
  return (
    <aside className="fixed inset-y-0 left-0 z-10 hidden w-14 flex-col border-r bg-color-background-pill-dark sm:flex">
      <nav className="flex flex-col items-center gap-4 px-2 sm:py-5">
        ...
        >
          <Image
            ...
            alt="Kotlin Logo"
          />
          <span className="sr-only">Naufal Fawwaz Andriawan</span>
        </Link>
        ...
        <NavItem href="/admin/projects" label="Orders">
...
function MobileNav() {
  return (
    <Sheet>
      ...
      <SheetContent
        side="left"
        className="sm:max-w-xs bg-white transition-all duration-200"
      >
