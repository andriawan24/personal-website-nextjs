...
export default function About() {
  return (
    <div className="px-32">
      ...
      {/* Section Skills */}
      <h3 className="font-bold text-3xl text-color-text-secondary">
        My Skills
      </h3>
      <div className="flex flex-row flex-wrap gap-6 pt-6 pb-16">
        <div className="flex flex-col gap-4 justify-center items-center p-6 bg-color-background-card-dark rounded-lg">
          ...
          />
          <h6 className="font-semibold text-2xl text-color-text-primary">
            Kotlin
          </h6>
        </div>
        <div className="flex flex-col gap-4 justify-center items-center p-6 bg-color-background-card-dark rounded-lg">
      ...
      <div className="flex flex-col pt-6 pb-56">
        <div className="pb-6">
          ...
          <p className="mt-4 text-xl leading-140 text-color-text-secondary">
            🚀 Key Achievements:
          </p>
